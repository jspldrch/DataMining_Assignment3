# run27: 716 features, 5 LGB + 2 XGB, lr=0.03, patience=100, no augmentation
...
print(f"\nfinal training (7 models, n_estimators={avg_best_iter})...")
...
for start, end, name in FEATURE_GROUPS:
    ...
    print(f"  {name:<32} {end-start:>5}   {pct:>7.1f}%")
